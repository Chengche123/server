...
type AuthService interface {
	...
	UserLogin(ctx context.Context, in *UserLoginRequest, opts ...client.CallOption) (*LoginResponse, error)
}
...
func (c *authService) UserLogin(ctx context.Context, in *UserLoginRequest, opts ...client.CallOption) (*LoginResponse, error) {
	req := c.c.NewRequest(c.name, "AuthService.UserLogin", in)
	out := new(LoginResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
func RegisterAuthServiceHandler(s server.Server, hdlr AuthServiceHandler, opts ...server.HandlerOption) error {
	type authService interface {
		...
		UserLogin(ctx context.Context, in *UserLoginRequest, out *LoginResponse) error
	}
	type AuthService struct {
		authService
	}
...
func (h *authServiceHandler) UserLogin(ctx context.Context, in *UserLoginRequest, out *LoginResponse) error {
	return h.AuthServiceHandler.UserLogin(ctx, in, out)
}
